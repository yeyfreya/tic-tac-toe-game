...
class TicTacToe:
    def __init__(self, player1, player2=None):
        ...
        self.winner = None
        self.game_id = str(int(datetime.timestamp(datetime.now())))  # Unique game id based on current timestamp
    ...
    def play_game(self):
        ...
        while self.winner is None and max_moves != 0:
            ...
            if self.winner:
                ...
                self.record_game_data()  # Record game data when the game is finished
            elif max_moves == 0:
                self.print_board()
                print("It's a draw!")
                self.record_game_data()  # Record game data when the game is finished
